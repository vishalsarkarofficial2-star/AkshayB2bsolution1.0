        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
            ...
            <div className="space-y-2.5">
              ...
              <ul className="space-y-1.5 text-slate-600">
                <li>
                  <button onClick={() => onSelectService('GST ITR Filing')} className="hover:text-[#0B3D91] transition-colors cursor-pointer">
                ...
                <li>
                  <button onClick={() => onSelectService('MSME Udyam ITR Filing')} className="hover:text-[#0B3D91] transition-colors cursor-pointer">
            ...
            <div className="space-y-2.5">
              ...
              <ul className="space-y-1.5 text-slate-600">
                <li>
                  <button onClick={() => onSelectService('Trademark ITR Filing')} className="hover:text-[#0B3D91] transition-colors cursor-pointer">
                    Trademark (™) ITR Filing
                  </button>
                </li>
                <li>
                  <button onClick={() => onSelectService('FSSAI ITR Filing')} className="hover:text-[#0B3D91] transition-colors cursor-pointer">
                    FSSAI Food License
                  </button>
                </li>
                <li>
                  <button onClick={() => onSelectService('IEC ITR Filing')} className="hover:text-[#0B3D91] transition-colors cursor-pointer">
