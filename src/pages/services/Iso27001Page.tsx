            ...
            <div className="bg-gradient-to-r from-[#0B3D91] via-[#0D47A1] to-[#082a66] text-white rounded-3xl p-6 sm:p-10 flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden shadow-xl">
              ...
              <div className="space-y-4 max-w-md relative z-10">
                ...
                <p className="text-xs text-slate-200 leading-relaxed">
                  Download the akshayb2bsolutions mobile application for iOS &amp; Android. Access your deed, ISO certification, and get direct CA chat support 24x7.
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
            ...
            <div className="space-y-2.5">
              ...
              <ul className="space-y-1.5 text-slate-600">
                ...
                <li>
                  <button onClick={() => onSelectService('Limited Liability Organization')} className="hover:text-[#0B3D91] transition-colors cursor-pointer">
