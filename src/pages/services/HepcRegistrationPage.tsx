          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
            ...
            <div className="space-y-2.5">
              ...
              <ul className="space-y-1.5 text-slate-600">
                ...
                <li>
                  <button onClick={() => onSelectService('Limited Liability HEPC applicant')} className="hover:text-[#0B3D91] transition-colors cursor-pointer">
                    Limited Liability HEPC applicant
                  </button>
                </li>
                <li>
