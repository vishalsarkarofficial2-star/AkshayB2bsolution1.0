...
interface LLPRegistrationLandingProps {
  onBackToHome: () => void;
...
export const LimitedLiabilityPartnershipPage: React.FC<LLPRegistrationLandingProps> = ({
  onBackToHome,
  onSelectService,
  onOpenBrochure,
  onOpenAppointment
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
            ...
            <div className="space-y-2.5">
              ...
              <ul className="space-y-1.5 text-slate-600">
                ...
                <li>
                  <button onClick={() => onSelectService('Limited Liability LLP')} className="hover:text-[#0B3D91] transition-colors cursor-pointer">
